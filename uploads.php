    ...
    if (in_array($fileActualExt, $allowed)) {
      ...
      if ($fileError === 0) {
        ...
        if ($fileSize < $letsize) {
          ...
          $fileNameNew = uniqid('', true).$thename.".".$fileActualExt;
          ...
          header("Location: index.php?youuploadedsilly");
        }
        else {
          echo "Your file is too big, $letsize byte maximum.";
        }
      }
      else {
      ...
      echo "You cannot upload files of this type!";
  	  ...
  	  header("Location: ../index.php?noooooo");
  	  exit();
  }
